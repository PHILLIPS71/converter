...
public interface IDirectoryRepository : IRepository<FileSystemDirectory, Id>
{
    public Task<List<FileSystemFile>> GetFiles(
    ...
    public Task<FileSystemDirectory?> GetDirectoryHierarchy(
        Id id,
        CancellationToken cancellation = default);
}
